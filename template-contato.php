    ...
    <div class="container">
        <div class="row">
            <div class="col-11 col-md-7 mx-auto mb-5">
                ...
                <select id="unidades" onChange="console.log('mmm');">
                    <option>Selecione</option>
                    <?php
                        query_posts( 'post_type=unidades&orderby=name&post_status=publish' );

                        while ( have_posts() ) : the_post();
                            $endereco = get_field('endereco_da_unidade');
                            $post_id = get_the_ID();
                            echo '<option value="' . $post_id . '" data-descr="' . $endereco . '">';
                            the_title();
                            echo '</option>';
                        endwhile;
                        wp_reset_query();
                ...
                <div class="row">
                    <div class="col-12 col-lg-5 mb-5">
                        ...
                        <address>Rodovia BR 101 S/N, KM 112, <br>Alagoinhas - BA</address>
